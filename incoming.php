        ...
        <div class="container">
          <div class="modal-body">
            <div class="form-group">
              <h4>Escanear <span class="badge badge-secondary">DensoLot: </span></h4>
              <input type="text" class="form-control" id="buscar" placeholder="Ingresar DensoLot.">
            </div>
              ...
              <form id="formDensoLot">
                <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="cantCajas" disabled="disabled">
                  </div>
